...
class CreateReservationRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'items.*.item.id' => 'required|distinct|exists:items,id',
    ...
    public function messages(){
      return [
        ...
        'items.*.item.id.required' => 'Rezervacija negali turėti neidentifikuojamų įrankių!',
        'items.*.item.id.distinct' => 'Į rezervaciją negalima pridėti to paties įrankio kelis kartus!',
        'items.*.item.id.exists' => 'Įrankio nepavyko identifikuoti duomenų bazėje. Bandykite dar kartą!',
