...
class Item extends Model
{
    ...
    protected $fillable = ['ItemName', 'ItemQuantity', 'ItemImage','ItemAcquiredFrom', 'ItemWarranty', 'ItemPurchase', 'ItemConsumable', 'ItemDeleted','ItemGroupID', 'ItemNote', 'ItemIdNumber'];
